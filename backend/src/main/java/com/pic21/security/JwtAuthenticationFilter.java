 ...
 * lo valida y carga el SecurityContext si el token es válido.
 * <p>
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        try {
            ...
            // No lanzamos la excepción → dejamos que el request continúe sin autenticar
            // Spring Security retornará 401 automáticamente si el endpoint lo requiere
        }
