...
public class TaskService {
    ...
    public List<TaskAssignmentResponse> createForAbsent(Long reunionId, TaskRequest request, String creatorUsername) {
        ...
        if (this.tareaRepository.existsById((Object)reunionId)) {
        ...
        Tarea savedTarea = tarea = (Tarea)this.tareaRepository.save((Object)tarea);
    ...
    public List<TaskAssignmentResponse> getAssignments(Long tareaId) {
        if (!this.tareaRepository.existsById((Object)tareaId)) {
    ...
    public List<TaskAssignmentResponse> addUsersToTask(Long tareaId, List<Long> userIds) {
        Tarea tarea = (Tarea)this.tareaRepository.findById((Object)tareaId).orElseThrow(() -> new ResourceNotFoundException("Tarea", tareaId));
    ...
    public TaskResponse updateTask(Long id, TaskRequest request) {
        Tarea tarea = (Tarea)this.tareaRepository.findById((Object)id).orElseThrow(() -> new ResourceNotFoundException("Tarea", id));
        ...
        log.info("Tarea id={} actualizada", (Object)id);
        return this.mapTask((Tarea)this.tareaRepository.save((Object)tarea), false);
    }

    @Transactional
    public void deleteTask(Long id) {
        Tarea tarea = (Tarea)this.tareaRepository.findById((Object)id).orElseThrow(() -> new ResourceNotFoundException("Tarea", id));
        this.tareaRepository.delete((Object)tarea);
        log.info("Tarea id={} '{}' eliminada", (Object)id, (Object)tarea.getTitulo());
    }
    ...
    public TaskResponse blockTask(Long id) {
        ...
        this.tareaRepository.save((Object)tarea);
        int updated = this.asignacionTareaRepository.updateEstadoByTareaIdAndEstado(id, EstadoTarea.PENDIENTE, EstadoTarea.BLOQUEADA);
        log.info("Tarea id={} bloqueada. Asignaciones pendientes bloqueadas={}", (Object)id, (Object)updated);
    ...
    public TaskResponse unblockTask(Long id) {
        ...
        log.info("Tarea id={} desbloqueada. Asignaciones reactivadas={}", (Object)id, (Object)updated);
        return this.mapTask(tarea, false);
    }
    ...
    public TaskAssignmentResponse changeAssignmentStatus(Long assignmentId, String estadoStr) {
        ...
        AsignacionTarea asignacion = (AsignacionTarea)this.asignacionTareaRepository.findById((Object)assignmentId).orElseThrow(() -> new ResourceNotFoundException("Asignaci\u00f3n", assignmentId));
        try {
        ...
        return this.mapAssignment((AsignacionTarea)this.asignacionTareaRepository.save((Object)asignacion));
    }
    ...
    private void registerAutoAttendance(Long reunionId, Long userId, String username, String reunionTitulo) {
        try {
            this.entityManager.createNativeQuery("INSERT INTO asistencias (reunion_id, usuario_id, fecha_registro, presente) VALUES (:reunionId, :userId, NOW(), true) ON CONFLICT (reunion_id, usuario_id) DO NOTHING").setParameter("reunionId", (Object)reunionId).setParameter("userId", (Object)userId).executeUpdate();
            log.info("Asistencia auto-registrada: user='{}', reunion='{}'", (Object)username, (Object)reunionTitulo);
        }
        catch (Exception ex) {
            log.warn("No se pudo auto-registrar asistencia para user='{}': {}", (Object)username, (Object)ex.getMessage());
        }
    }
    ...
    private TaskAssignmentResponse mapAssignment(AsignacionTarea a) {
        ...
        if (raw != null && !raw.isBlank()) {
            try {
                ...
                safeQuestions = mapper.writeValueAsString((Object)qs);
            }
            catch (Exception e) {
                safeQuestions = raw;
            }
