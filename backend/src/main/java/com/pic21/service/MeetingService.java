...
public class MeetingService {
    ...
    public MeetingResponse create(MeetingRequest request, String username) {
        ...
        Reunion saved = (Reunion)this.reunionRepository.save((Object)reunion);
    ...
    public MeetingResponse update(Long id, MeetingRequest request, boolean isAdmin) {
        ...
        log.info("Reuni\u00f3n actualizada: id={}{}", (Object)id, (Object)(isAdmin ? " (por ADMIN, reuni\u00f3n bloqueada)" : ""));
        return this.mapToResponse((Reunion)this.reunionRepository.save((Object)reunion));
    }
    ...
    public void delete(Long id) {
        if (!this.reunionRepository.existsById((Object)id)) {
            throw new ResourceNotFoundException("Reuni\u00f3n", id);
        }
        this.entityManager.createNativeQuery("DELETE FROM asistencias WHERE reunion_id = :id").setParameter("id", (Object)id).executeUpdate();
        this.entityManager.createNativeQuery("DELETE FROM asignaciones_tarea WHERE tarea_id IN (SELECT id FROM tareas WHERE reunion_id = :id)").setParameter("id", (Object)id).executeUpdate();
        this.entityManager.createNativeQuery("DELETE FROM tareas WHERE reunion_id = :id").setParameter("id", (Object)id).executeUpdate();
        this.entityManager.createNativeQuery("DELETE FROM meeting_files WHERE meeting_id = :id").setParameter("id", (Object)id).executeUpdate();
        this.entityManager.createNativeQuery("DELETE FROM reuniones WHERE id = :id").setParameter("id", (Object)id).executeUpdate();
        log.info("Reuni\u00f3n id={} eliminada con asistencias, tareas y archivos", (Object)id);
    }
    ...
    public MeetingResponse uploadPdf(Long id, MultipartFile file) {
        ...
        log.info("PDF subido para reuni\u00f3n id={}", (Object)id);
        return this.mapToResponse((Reunion)this.reunionRepository.save((Object)reunion));
    }
    ...
    private Reunion findOrThrow(Long id) {
        return (Reunion)this.reunionRepository.findById((Object)id).orElseThrow(() -> new ResourceNotFoundException("Reuni\u00f3n", id));
    }
